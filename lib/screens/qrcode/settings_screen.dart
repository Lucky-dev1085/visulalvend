...
class SettingsScreen extends StatefulWidget {
  ...
  const SettingsScreen({Key key, this.onCallback, this.onChangeSearchOption, }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Container(
            width: double.infinity, height: 52, color: darkGreyColor,
            margin: EdgeInsets.only(top: 8),
            child: Stack(
              alignment: Alignment.centerLeft,
              children: [
                Center(child: Text('Settings', style: semiBold.copyWith(fontSize: 26, color: Colors.white, fontWeight: FontWeight.bold),)),
                Row(
                  children: [
                    InkWell(
                      child: Container(
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text('Search Options', style: semiBold.copyWith(fontSize: 16, color: Colors.white, ),),
                    Container(
                    ...
                    SizedBox(height: 16,),
                    Text('Menu Preferences  Options', style: semiBold.copyWith(fontSize: 16, color: Colors.white, ),),
                    Container(
                      width: double.infinity, height: 48,
                      margin: EdgeInsets.symmetric(horizontal: 6, vertical: 6),
                      child: DropDownWidget(
                    ...
                    SizedBox(height: 16,),
                    Text('Wallet Option', style: semiBold.copyWith(fontSize: 16, color: Colors.white, ),),
                    Container(
                      ...
                      child: Row(
                        children: [
                          SizedBox(width: 12,),
                          Icon(Icons.monetization_on, size: 38, color: Colors.black.withOpacity(0.8),),
                          SizedBox(width: 12,),
                          Text('Linked Account', style: semiBold.copyWith(fontSize: 16, color: Colors.black.withOpacity(0.85), ),),
                          Spacer(),
                          Icon(Icons.arrow_forward_ios, size: 23, color: Colors.black.withOpacity(0.8),),
                          SizedBox(width: 12,),
                        ],
                      ),
                    ...
                    SizedBox(height: 16,),
                    Text('Cart Option', style: semiBold.copyWith(fontSize: 16, color: Colors.white, ),),
                    Container(
                      width: double.infinity, height: 52,
                      margin: EdgeInsets.symmetric(horizontal: 6, vertical: 8),
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12,),
                          Text('Your Cart', style: semiBold.copyWith(fontSize: 16, color: Colors.black.withOpacity(0.85), ),),
                          Spacer(),
                          Icon(Icons.arrow_forward_ios, size: 23, color: Colors.black.withOpacity(0.8),),
                          SizedBox(width: 12,),
                        ],
                    ...
                    SizedBox(height: 16,),
                    Text('Product Setting', style: semiBold.copyWith(fontSize: 16, color: Colors.white, ),),
                    Container(
                      width: double.infinity, height: 48,
                      margin: EdgeInsets.symmetric(horizontal: 6, vertical: 6),
                      child: DropDownWidget(
